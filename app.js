...
const translations = {
    en: {
        appTitle: 'Immobilier Analyser',
        appSubtitle: 'Compare Renting vs Buying vs Inheriting in France',
        parameters: 'Parameters',
        adjustRealTime: 'Adjust to see real-time changes',
        property: 'Property',
        ...
        rentInflation: 'Annual Inflation',
        lifeEvents: 'Life Events',
        buyingAge: 'Buying Age',
        inheritanceAge: 'Inheritance Age',
        frenchTaxes: 'French Taxes',
        ...
        buy: 'Buy',
        inherit: 'Inherit',
        cumulative: 'Cumulative Costs Over Time',
        totalAmount: 'Total amount spent from age 25 to 85',
        netCost: 'Net Cost After Equity',
        realBurden: 'Real financial burden when accounting for home equity',
        totalSpent: 'Total Spent',
        equityAt85: 'Equity at 85',
        renting: 'Renting',
        buying: 'Buying',
    ...
    fr: {
        appTitle: 'Analyseur Immobilier',
        appSubtitle: 'Comparer la Location vs l\'Achat vs l\'Héritage en France',
        parameters: 'Paramètres',
        adjustRealTime: 'Ajuster pour voir les changements en temps réel',
        property: 'Propriété',
        ...
        rentInflation: 'Inflation Annuelle',
        lifeEvents: 'Événements de Vie',
        buyingAge: 'Âge d\'Achat',
        inheritanceAge: 'Âge d\'Héritage',
        frenchTaxes: 'Taxes Françaises',
        inheritanceTax: 'Taxe de Succession',
        ...
        buy: 'Achat',
        inherit: 'Héritage',
        cumulative: 'Coûts Cumulés au Fil du Temps',
        totalAmount: 'Montant total dépensé de 25 à 85 ans',
        netCost: 'Coût Net Après Équité',
        realBurden: 'Charge financière réelle en comptabilisant l\'équité du logement',
        totalSpent: 'Total Dépensé',
        equityAt85: 'Équité à 85 ans',
        renting: 'Location',
        buying: 'Achat',
        inheriting: 'Héritage',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(() => {
        update();
        // Force chart resize after render
        setTimeout(() => {
            echarts.util.getInstances().forEach(c => c.resize());
        }, 100);
    }, 50);
